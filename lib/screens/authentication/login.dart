...
class _Login extends State<Login> {
  ...
  goToMain(BuildContext contextParam) {
    final provider = Provider.of<AllGamesProvider>(contextParam, listen: false);

    Navigator.pushAndRemoveUntil(
        contextParam,
        MaterialPageRoute(builder: (_) => NavigationTabs(provider)),
        (route) => false
