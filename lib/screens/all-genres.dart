...
class AllGenresState extends State<AllGenres> with SingleTickerProviderStateMixin  {
        ...
        final image = genre.image == null ?  'assets/action.jpg' : '${genre.image}';
          return ListTile(
            ...
            trailing: IconButton(
              ...
              icon: Icon(Icons.arrow_right, color: Color(0xffE91E63),)
            ,),
          );
