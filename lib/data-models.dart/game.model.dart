class GameSimple {
  ...
  factory GameSimple.fromJson(Map<String, dynamic> parsedData) {
    ...
    List<dynamic> serializedGenres =
        genres.map((i) => GanresSimple.fromJson(i)).toList();
    List<dynamic> serializedScreenShots =
        screenshots.map((i) => GameScreenShots.fromJson(i)).toList();
...
//     List<dynamic> serializedGames =
//         games.map((i) => GamesNoImage.fromJson(i)).toList();
//     return GameGenres(
//         name: parsedData['name'],
//         id: parsedData['id'],
...
class GamePlatforms {
  ...
  GamePlatforms({this.name, this.id, this.image});
