...
class GameDetailState extends State<GameDetail>
  ...
  buildGamePlayCards(imageUrl) {
    return Column(
      children: <Widget>[
        Container(
            height: 60, width: 60, decoration: smallImageDecoration(imageUrl)),
      ],
    );
  }
  ...
  Widget buildGamePlay2() {
    return Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: NetworkImage('${widget.game.screenShots[0].image}')))
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.black,
      body: widget.provider.isLoading == true ||
              widget.provider.singleGame.platform == null
          ? Container(
              height: 40,
              width: 40,
